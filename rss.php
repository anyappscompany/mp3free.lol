...
$result = mysql_query("SELECT * FROM (SELECT * FROM songs ORDER BY id DESC LIMIT ".$rsstotal.") as tmp ORDER BY id DESC");
...
$rss .='
    <item>
        <title>'.$rssauthor.' - '.preg_replace ("/[^\p{L}0-9]/iu"," ",$title).$rssoneitemafter.'</title>
