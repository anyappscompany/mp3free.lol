...
//$api_id = '4938000';
//$vk_id  = '166104317';
//это ID станицы, с которой вы создали своё приложение и получили доступ (описано в первом посте)
$api_id = $_GET['apiid'];
$vk_id = $_GET['vkid'];
$query = $_GET['query'];
$count = $_GET['count'];
...
$resp = $VK->api('audio.search', array(
        'q' => $query, //сам запрос
        'auto_complete' => 0, //автоматическое исправление, если запрос в виде "Еру Иуфедуы" (The Beatles)
        'sort' => '2', // сортировка - по популярности
        'count' => $count, //количество результатов в ответе
